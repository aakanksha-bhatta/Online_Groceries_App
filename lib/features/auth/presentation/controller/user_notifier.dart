...
Future<void> loadUsers() async {
  ...
  final userListJson = prefs.getStringList(_usersKey) ?? [];
 ...
 Future<void> saveUsers(User user) async {
  ...
  final userListJson = updatedUsers.map((user) => jsonEncode(user.toJson())).toList();
  await prefs.setStringList(_usersKey, userListJson);
  state = updatedUsers;
